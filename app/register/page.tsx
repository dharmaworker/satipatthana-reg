          ...
          {step === 1 && (
            <div className="step-content active">
              ...
              <div className="info-section">
                <h3>唯一路</h3>
                <p>離苦的唯一路，<br />即是毗缽舍那（Vipassanā）的修行。<br />修習四念處，本身就是通往覺醒之道。</p>
                <p>承蒙 隆波帕默尊者體系助教老師指導，<br />於水月之間，共修四念處覺醒之道。<br />本次禪修將於 2026 年 8 月 20 日至 8 月 24 日，<br />於南投日月潭湖畔會館展開，為期五日四夜。</p>
