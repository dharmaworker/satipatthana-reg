            ...
            <div className="step-content active">
              ...
              <div className="info-section">
                ...
                <ul>
                  ...
                  <li>麥琪奧蘭努 Ajahn Khun Mae Oranuch Santayakorn</li>
                </ul>
                <h4>【親臨授課】</h4>
          ...
          {step === 2 && (
            <div className="step-content active">
              ...
              <div className="info-section">
                ...
                <div className="meta-row"><span className="k">課程費用</span><span className="v">課程免費<br />8/20–8/24 禪修期間之食宿、交通及場地費用：NT$18,600 元整<br />（如需提前或延後住宿，將另計相關費用）</span></div>
              </div>
            </div>
          )}
        ...
        <aside>
          ...
          <div className="sidebar-card" style={{ background: 'rgba(216, 194, 154, 0.18)', borderColor: 'rgba(180, 147, 88, 0.3)' }}>
            ...
            <p style={{ marginTop: 10 }}>
              提交後系統會寄出確認信，內含您的<strong>專屬專屬碼</strong>，請妥善保管。
            </p>
          </div>
