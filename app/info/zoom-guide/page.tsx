  ...
  return (
    <>
      ...
      <ZgArt>
        ...
        <ZgP mb={18}>第三個按鈕是「<strong>參與者</strong>」，可供您修改學號和名字。如果進房間之後發現您的名字有誤，請點擊參與者，隊列裡面的第一個就是您。請點擊您的名字，然後選擇「<strong>改名</strong>」，將自己的名字修改為學號＋中文姓名（若無學號則用報名序號），例如：「A8＋王小明」。</ZgP>
        <div className="zg4">
          ...
          <ZgCard n={4} title="改成學號＋中文姓名" html={`<svg viewBox="0 0 130 86" width="100%" style="display:block;margin:0 auto 6px;max-width:120px"><rect x="8" y="6" width="114" height="74" rx="12" fill="#fff" stroke="#5e4b3c" stroke-width="3"/><text x="65" y="26" font-family="'Noto Sans TC',sans-serif" font-size="12" font-weight="900" fill="#3a2f25" text-anchor="middle">輸入新名字</text><rect x="16" y="34" width="98" height="30" rx="8" fill="#fffdf7" stroke="#1f8a5b" stroke-width="3"/><text x="65" y="54" font-family="'Noto Sans TC',sans-serif" font-size="14" font-weight="900" fill="#2f7d57" text-anchor="middle">A8＋王小明</text></svg>`} style={{ padding: '20px 12px 14px' }} />
        </div>
      </ZgArt>
